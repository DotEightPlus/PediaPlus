      ...
      <div class="container">
        <div class="row align-items-center">
          ...
          <div class="col-11 col-xl-4">
            <h1 class="mb-0 site-logo"><a href="./" class="text-white mb-0">PediaPlus<sup style="font-size: 12px"><i class="icon-plus"></i></sup></a></h1>
          </div>
            ...
            <nav class="site-navigation position-relative text-right" role="navigation">
              ...
              <ul class="site-menu js-clone-nav mr-auto d-none d-lg-block">
                <li><a href="./"><span>Home</span></a></li>
                 <li><a href="dashboard/./pdf"><span>PDFs</span></a></li>
                <li><a href="./signin"><span>Sign in</span></a></li>
               <li><a href="./ads"><span>Ads Center</span></a></li>
                <li><a href="dashboard/./donate"><span>Donate PDF</span></a></li>
