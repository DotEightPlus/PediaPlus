        ...
        <div class="main-header-area">
            <div class="classy-nav-container breakpoint-off">
                ...
                <nav class="classy-navbar justify-content-between" id="monaNav">
                    ...
                    <!-- Logo -->
                    <a class="nav-brand" href="index.html" style="width:400px"><img src="./img/core-img/newname.png"
                            alt=""></a>
                    ...
                    <div class="blog-details-content mt-5 mb-80">
                        ...
                        <div class="post-details-text">
                            <img src="blogadmin/images/<?php echo $row['photo']; ?>" class="img-fluid"
                                alt="image not available" style="width:400px;height: 400px;">
                            ...
                            <div class="post-content mt-30 mb-30">
                                ...
                                <div class="post-meta">
                                    <a href="#" class="post-date"><i class="fa fa-tags"></i>
                                        <?php  echo $row['tags']; ?></a>
                                    <a href="#" class="post-view"><i class="fa fa-eye fa-x2 post-view "
                                            aria-hidden="true"></i>
                                        <?php echo $roo['count']; ?>
                                    </a>

                                    <a href="#comment_no" class="post-comments"><i class="fa fa-comments"
...
echo $url;  
  ?>" data-action="share/whatsapp/share" data-media="<?php echo $row['photo']; ?>"><span
...
echo $url; ?>" target="_blank" title="Facebook" data-media="<?php echo $row['photo']; ?>"><span
...
echo $url; ?>" target="_blank" title="Twitter" data-media="<?php echo $row['photo']; ?>"><span
                                ...
                                <form id="frm-comment">
                                    <div class="row">
                                        <div class="col-lg-6">
                                            ...
                                            <input class="form-control mb-15" type="text" name="name" id="name"
                                                placeholder="Name" />
                                        </div>
                                        <div class="col-lg-6 col-md-12 col-sm-12">
                                            <input type="email" id="email" class="form-control mb-15"
                                                placeholder="Email">
                                        </div>
                                        <div class="col-12 col-md-12 col-sm-12">
                                            <textarea name="comment" id="comment" type="text" class="form-control mb-15"
                                        ...
                                        <div class="col-12">
                                            ...
                                            <button type="button" id="submitButton"
                                                class="btn mona-btn btn-2 mt-15">Post Comment</button>
                                        </div>
                                    </div>
                ...
                <div class="col-12 col-lg-4">
                    <div class="sidebar-area mt-5">
                        ...
                        <!-- Single Widget Area -->
                        <div class="single-widget-area catagories-widget mb-20"
