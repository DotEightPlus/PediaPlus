          ...
          <div class="col-md-10">
            ...
            <div class="row justify-content-center mb-4">
              <div class="col-md-10 text-center">
                <h1 data-aos="fade-up" class="mb-5">Next Step;<br/><span class="typed-words"></span></h1>
              </div>
            </div>
      ...
      <div class="container">
        <div class="block-quick-info-2-inner">
                <div class="text text-center">
                  <strong class="d-block heading">Verify your Email Address</strong>
                  <span class="excerpt"><a href="#">We`ve sent a verification link to your email address </a></span>
          </div>
        </div>
      </div>
    </div>
